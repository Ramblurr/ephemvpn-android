        ...
        try {
            ...
            while ((zipEntry = zipInputStream.getNextEntry()) != null) {
                ...
                if (file2.exists()) {
                    if (replaceIfExists) {
                        ...
                        try {
                            ...
                            if (!b) {
                                Log.e(GlobalConstants.LOG_TAG, "Unzip failed to delete " + dest
                                        + zipEntryName);
                            } else {
                                Log.d(GlobalConstants.LOG_TAG, "Unzip deleted " + dest
                                        + zipEntryName);
                            }
                        } catch (Exception e) {
                            Log.e(GlobalConstants.LOG_TAG, "Unzip failed to delete " + dest
                ...
                if (file.getName().endsWith(".so") || file.getName().endsWith(".py")
                        || file.getName().endsWith(".pyc") || file.getName().endsWith(".pyo")) {
                    FileUtils.chmod(file, 0755);
                }
        ...
        try {
            ...
            if (!file.exists()) {
                try {
                    ...
                    Log.d(GlobalConstants.LOG_TAG, "createDirectoryOnExternalStorage created "
            ...
            // }
            // else {
            // Log.e(GlobalConstants.LOG_TAG,"createDirectoryOnExternalStorage error: "
