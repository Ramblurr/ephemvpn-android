...
public class PythonScriptProcess extends InterpreterProcess {
    ...
    public PythonScriptProcess(File paramFile,
            InterpreterConfiguration paramInterpreterConfiguration, AndroidProxy paramAndroidProxy) {
        super(new MyInterpreter(null), paramAndroidProxy);
        this.mScript = paramFile;
        setName(paramFile.getName());

        String str = "";
        // if(paramInterpreterConfiguration.getInterpreterForScript("foo.py") !=
        // null) {
        // str =
        // paramInterpreterConfiguration.getInterpreterForScript("foo.py").getScriptCommand();
        // }
